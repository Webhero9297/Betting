...
import betting_artifacts from '../../build/contracts/BettingSimple.json';

var Voting = contract(betting_artifacts);
...
window.krakenTick = function () {
  console.log("Ticker button clicked");
  Voting.deployed().then(function(contractInstance) {
    // contractInstance.fetchResult.call().then(function(price) {
    //   console.log(price);
    //   $('#krakenTicker').html(price.toString());
    // });
    // contractInstance.sendEther({value: web3.toWei(0.5, 'ether'),from: web3.eth.accounts[0] }).then(function(value){
    //   // console.log("Ethers sent:"+value);
    // });
    // contractInstance.reward.call().then(function(){
    //   console.log("rewarded");
    // });
    // contractInstance.fetchStatus.call().then(function(status){
    //   console.log(status);
    // });
  });
